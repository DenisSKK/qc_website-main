...
class MercuryITCDevice(Device):
    ...
    def update_all_xml(self, xml):
        ...
        try:
            ...
            try:
                self.update_temperature_set_point(self.config["ITC_temperature_set_point"])
            except:
                print("Updating temperature set point failed")
            try:
                self.update_voltage(self.config["ITC_voltage"])
            except:
                print("Updating voltage failed")
            try:
                self.update_automatic_heating(self.config["ITC_automatic_heating"])
            except:
                print("Updating automatic heating failed")
            try:
                self.update_automatic_pid(self.config["ITC_automatic_pid"])
            except:
                print("Updating automatic pid failed")
            print("ITC Updated")
        except:
            print("XML not Found")
